      ...
      <div className="max-w-[1440px] mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 bg-[#C6A75E] text-white px-8 py-5 hidden md:flex flex-col items-center shadow-lg z-20">
              <span className="font-playfair text-3xl font-light">11+</span>
              <span className="text-[8px] tracking-[0.3em] uppercase mt-1">Especialidades</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 lg:col-start-7 text-center lg:text-left">
            ...
            <div className="max-w-[540px] mx-auto lg:mx-0">
              ...
              <p
                className="text-base md:text-lg text-[#8C877F] font-light leading-relaxed italic mb-10"
                data-aos="fade-up"
                data-aos-delay="500"
              >
              ...
              <div data-aos="fade-up" data-aos-delay="600" className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 flex items-center justify-center border border-[#C6A75E]/30 rounded-full">
                    <div className="w-2 h-2 rounded-full bg-[#C6A75E]" />
                  </div>
                  <div>
                    <p className="text-xs tracking-[0.15em] uppercase text-[#1C1C1C] font-medium">Humanizado</p>
                    <p className="text-[10px] text-[#8C877F]">Cuidado personalizado</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 flex items-center justify-center border border-[#C6A75E]/30 rounded-full">
                  ...
                  <div>
                    <p className="text-xs tracking-[0.15em] uppercase text-[#1C1C1C] font-medium">Científico</p>
                    <p className="text-[10px] text-[#8C877F]">Baseado em evidências</p>
                  </div>
                </div>
              </div>
            </div>
